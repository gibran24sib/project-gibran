  ...
  const actions = [
    {
      ...
      icon: UserPlus,
      color: "bg-primary",
      description: "Tambah data pasien baru",
    },
    {
      id: "new_appointment",
      label: "Buat Janji",
      icon: CalendarPlus,
      color: "bg-secondary",
      description: "Jadwalkan perawatan",
    },
    {
      id: "start_exam",
      label: "Pemeriksaan",
      icon: Stethoscope,
      color: "bg-third",
      description: "Catat tindakan medis",
    },
    {
      id: "payment",
      label: "Pembayaran",
    ...
    },
    {
      ...
      icon: MessageCircle,
      color: "bg-green-500",
      description: "Kirim notifikasi massal",
    },
    {
      id: "report",
      label: "Laporan",
    ...
    },
    {
      ...
      icon: Users,
      color: "bg-teal-500",
      description: "Lihat feedback pasien",
    },
  ];
      ...
      <div className="p-4 grid grid-cols-2 gap-3">
        {actions.map((action) => {
          ...
          return (
            ...
            >
              <div
                className={`p-2 rounded-lg ${action.color} text-white mb-2 group-hover:scale-110 transition`}
              >
                <Icon size={20} />
              </div>
