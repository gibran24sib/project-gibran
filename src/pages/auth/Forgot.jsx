...
const Forgot = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        if (
          dentalAPI.communicationLogs &&
          dentalAPI.communicationLogs.logOutgoing
        ) {
    ...
    <div>
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-2 text-sm">
          Masukkan email untuk memulihkan akses
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 items-center">
        ...
        <div className="text-center">
          <Link
            to="/login"
            className="text-xs text-gray-500 hover:text-blue-600 font-bold transition-colors"
          >
